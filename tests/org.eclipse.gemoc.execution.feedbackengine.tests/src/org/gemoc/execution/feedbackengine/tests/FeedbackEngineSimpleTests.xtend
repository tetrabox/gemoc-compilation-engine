...
class FeedbackEngineSimpleTests {
	public static val ad2petriModelsPlugin = "org.eclipse.gemoc.activitydiagram.sequential.ad2petri.models"

	@Test
	def void test1() {
		TestHelper::testWithoutExtraAddons(new FeedbackEngineWrapper(), new CompiledActivityDiagram(),
			new TestModel(ad2petriModelsPlugin, "/basic", "test1.xmi", "", "?lang=org.eclipse.gemoc.activitydiagram.sequential.ad2petri.CompiledActivityDiagram"))
	}
