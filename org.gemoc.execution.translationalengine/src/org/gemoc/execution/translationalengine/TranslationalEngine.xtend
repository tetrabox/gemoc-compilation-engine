...
class TranslationalEngine extends AbstractSequentialExecutionEngine {

	var TranslationalInterpreter backInterpreter
	...
	public def void setInterpreter(TranslationalInterpreter backInterpreter) {
