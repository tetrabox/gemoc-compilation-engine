 ...
 * </p>
 * <ul>
 *   <li>{@link gemoctraceability.impl.TraceabilityModelImpl#getLinks <em>Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TraceabilityModelImpl extends MinimalEObjectImpl.Container implements TraceabilityModel {
	...
	protected EClass eStaticClass() {
		return GemoctraceabilityPackage.Literals.TRACEABILITY_MODEL;
	}
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<Link>(Link.class, this, GemoctraceabilityPackage.TRACEABILITY_MODEL__LINKS);
		}
		return links;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GemoctraceabilityPackage.TRACEABILITY_MODEL__LINKS:
