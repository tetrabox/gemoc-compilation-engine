 ...
 * @generated
 */
public class GemoctraceabilitySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public GemoctraceabilitySwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GemoctraceabilityPackage.TRACEABILITY_MODEL: {
				TraceabilityModel traceabilityModel = (TraceabilityModel)theEObject;
				T result = caseTraceabilityModel(traceabilityModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GemoctraceabilityPackage.LINK: {
				Link link = (Link)theEObject;
				T result = caseLink(link);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GemoctraceabilityPackage.ANNOTATED_ELEMENT: {
