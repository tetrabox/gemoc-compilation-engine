...
public class ActivityAspect {
  ...
  public static void initialize(final Activity _self, final List<String> args) {
    final org.eclipse.gemoc.activitydiagram.sequential.ad2petri.compiledactivitydiagram.aspects.ActivityAspectActivityAspectProperties _self_ = org.eclipse.gemoc.activitydiagram.sequential.ad2petri.compiledactivitydiagram.aspects.ActivityAspectActivityAspectContext.getSelf(_self);
    _privk3_initialize(_self_, _self,args);;
  }
  
  @Main
  public static void main(final Activity _self) {
	final org.eclipse.gemoc.activitydiagram.sequential.ad2petri.compiledactivitydiagram.aspects.ActivityAspectActivityAspectProperties _self_ = org.eclipse.gemoc.activitydiagram.sequential.ad2petri.compiledactivitydiagram.aspects.ActivityAspectActivityAspectContext
			.getSelf(_self);
  ...
  public static ActivityNode findReadyNode(final Activity _self) {
	...
	;
	return (org.eclipse.gemoc.activitydiagram.sequential.ad2petri.compiledactivitydiagram.activitydiagram.ActivityNode) result;
}
