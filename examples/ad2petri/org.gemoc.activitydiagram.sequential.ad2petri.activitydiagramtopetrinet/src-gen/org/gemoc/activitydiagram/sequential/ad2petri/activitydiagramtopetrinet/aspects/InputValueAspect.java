...
public class InputValueAspect {
  public static Variable variable(final InputValue _self) {
	final org.gemoc.activitydiagram.sequential.ad2petri.activitydiagramtopetrinet.aspects.InputValueAspectInputValueAspectProperties _self_ = org.gemoc.activitydiagram.sequential.ad2petri.activitydiagramtopetrinet.aspects.InputValueAspectInputValueAspectContext
			.getSelf(_self);
	Object result = null;
	result = _privk3_variable(_self_, _self);
	;
	return (org.gemoc.activitydiagram.sequential.ad2petri.activitydiagramtopetrinet.activitydiagram.Variable) result;
}
    	...
    	for (java.lang.reflect.Method m : _self.getClass().getMethods()) {
    		if (m.getName().equals("getVariable") &&
    			m.getParameterTypes().length == 0) {
    				...
    				if (ret != null) {
    					return (org.gemoc.activitydiagram.sequential.ad2petri.activitydiagramtopetrinet.activitydiagram.Variable) ret;
    				}
    		}
    	}
    } catch (Exception e) {
