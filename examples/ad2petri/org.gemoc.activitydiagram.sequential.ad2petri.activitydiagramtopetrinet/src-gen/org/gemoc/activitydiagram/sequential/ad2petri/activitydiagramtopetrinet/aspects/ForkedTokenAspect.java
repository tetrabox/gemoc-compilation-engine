...
public class ForkedTokenAspect {
  public static Token baseToken(final ForkedToken _self) {
	final org.gemoc.activitydiagram.sequential.ad2petri.activitydiagramtopetrinet.aspects.ForkedTokenAspectForkedTokenAspectProperties _self_ = org.gemoc.activitydiagram.sequential.ad2petri.activitydiagramtopetrinet.aspects.ForkedTokenAspectForkedTokenAspectContext
			.getSelf(_self);
	Object result = null;
	result = _privk3_baseToken(_self_, _self);
	;
	return (org.gemoc.activitydiagram.sequential.ad2petri.activitydiagramtopetrinet.activitydiagram.Token) result;
}
    	...
    	for (java.lang.reflect.Method m : _self.getClass().getMethods()) {
    		if (m.getName().equals("getBaseToken") &&
    			m.getParameterTypes().length == 0) {
    				...
    				if (ret != null) {
    					return (org.gemoc.activitydiagram.sequential.ad2petri.activitydiagramtopetrinet.activitydiagram.Token) ret;
    				}
    		}
    	}
    } catch (Exception e) {
